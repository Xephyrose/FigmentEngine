...
float4 main(PSInput input) : SV_TARGET {
    ...
    float bias = 0.00001; // lower values can cause something akin to AO. this could be good or bad. higher values may produce peter panning (shadows disconnected from source mesh).
