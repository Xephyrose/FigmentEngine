...
struct AppState {
    ...
    Camera2D* current_camera_2d = nullptr;
    Camera3D* current_camera_3d = nullptr;
    ...
    SDL_GPUBuffer* pointLightBuffer = nullptr;
    SDL_GPUBuffer* directionalLightBuffer = nullptr;
    SDL_GPUBuffer* spotLightBuffer = nullptr;
    SDL_GPUTransferBuffer* pointLightTransferBuffer = nullptr;
    SDL_GPUTransferBuffer* directionalLightTransferBuffer = nullptr;
    SDL_GPUTransferBuffer* spotLightTransferBuffer = nullptr;
    ...
    SDL_Surface* DownloadGPUTexture(SDL_GPUTexture* texture) const;
